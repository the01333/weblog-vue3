    ...
    <div class="grid grid-cols-4 gap-7">
      ...
      <div class="col-span-4 md:col-span-3 mb-3">
        ...
        <div
          ...
          <!-- 正文（使用 v-html 进行渲染） -->
          <div ref="articleContentRef" v-viewer class="mt-5 article-content" v-html="article.content"></div>
          <!-- 标签集合 -->
          <div v-if="article.tagList && article.tagList.length > 0" class="mt-5">
...
watch(route, (newValue, oldValue) => {
  refreshArticleDetail(newValue.params.articleId)
})
